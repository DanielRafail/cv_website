        ...
        <div className="no-margin">
          <div className="index-container no-margin">
            ...
            <div className="index-container-text-container">
              ...
              <Typography variant="body1" className="index-container-text-center-description">Full Stack Software Developper</Typography>
            </div>
          </div>
